...
public class BTLEUart extends ContextWrapper{
    ...
    /**
     * Start connection with given bluetooth mac address
    ...
    /**
     * Disconnect actually connected device
     */
    ...
    /**
     * Write string to serivce buffer, and send it to connected device
     */
     ...
     * Call listener according to result of BTLE initialization
     */
    ...
    /**
     * Connection listener.
     * Call listener according to connection try.
     */
    ...
    /**
     * Data listener.
     * Call listener according when data is received.
     */
    ...
    /**
     * Initial builder.
     * After setting listeners you must call this one to build class.
     */
    ...
    /**
     * UartService event receiver
     *
     * moves events to main UI threads
     */
    ...
    /**
     * Use this method in your activity onDestroy()
     *
     * It will close connection and remove receiver. If you don't use this, it make cause memory leak
     */
    public void onDestroy(){
        if (uartService != null) {
            ...
            try {
                LocalBroadcastManager.getInstance(this).unregisterReceiver(uartReceiver);
